    ...
    <v-container fluid grid-list-md>
        ...
        <v-layout row justify-space-around class="pt-4">
            <v-flex class="text-xs-center" xs2>
                <img   src="../../../assets/imagenes/profunda/ejercicio3/mama.png" width="120px">
            </v-flex>
...
export default {
    ...
    data(){
        return {
            ...
            controlOnStart: true,
            resultado_ejercicio5: this.$route.params.result5,
    ...
    computed: {
        observable(){
            ...
            if(vm.list1.length == 1){
                ...
                console.log(amount);
                let result = amount + parseInt(vm.resultado_ejercicio5);
                //vm.$router.push({ path: `/resultadoprofunda/${result}`});
                vm.$router.push({ path: `/resultadotestcompleto/`,
                    query: {
                        ...
                        valor_ejercicio3_profundo: {
                            ejercicio3_1: vm.valor_ejercicio3_profundo.ejercicio3_1,
                            ejercicio3_2:{
                                data: vm.list1,
                                punteo: amount
                            }
    ...
    created(){
        let vm =this;
        vm.playSound('encuentra_letra_m.mp3');
    },
    methods:{
        getImgUrl(pic) {
